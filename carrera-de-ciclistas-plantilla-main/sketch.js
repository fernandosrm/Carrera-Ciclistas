...
function pinkCyclists(){
        player1 =createSprite(1100,Math.round(random(50, height-100)));
        player1.scale =0.06;
...
function yellowCyclists(){
        player2 =createSprite(1100,Math.round(random(50, height-100)));
        player2.scale =0.06;
...
function redCyclists(){
        player3 =createSprite(1100,Math.round(random(50, height-100)));
        player3.scale =0.06;
